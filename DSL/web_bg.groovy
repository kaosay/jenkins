pipelineJob('te-web-bg') {
    description('---- test evironment ----\n\nweb-bg of jinsuai.com!')
...
pipeline {
    ...
    // set up triggers
    triggers {
    gitlab branchFilterType: 'RegexBasedFilter', excludeBranchesSpec: '', includeBranchesSpec: '', noteRegex: 'Jenkins please retry a build', pendingBuildName: '', secretToken: '', skipWorkInProgressMergeRequest: true, sourceBranchRegex: '.*test.*', targetBranchRegex: '', triggerOnApprovedMergeRequest: true, triggerOpenMergeRequestOnPush: 'never'
    }
